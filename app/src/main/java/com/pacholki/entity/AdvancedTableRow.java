...
public class AdvancedTableRow {
    ...
    public static final List<String> colNames = List.of(
            ...
            "Position",
            "Expected Goals",
            "Expected Non-Penalty Expected Goals",
            "Expected Assists",
            "Expected Non-Penalty Expected Goals + Expected Assists",
            "Progression Prg C",
            "Progression Prg P",
            "Progression Prg R",
            "Per90 Goals",
            "Per90 Assists",
            "Per90 Goals and Assists",
            "Per90 Goals from Penalty Kicks",
            "Per90 Goals and Assists from Penalty Kicks",
            "Per90 Expected Goals",
            "Per90 Expected Assists",
